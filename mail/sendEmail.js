...
function sendEmail(toEmail, subject, text, addFooter, cc) {
  return new Promise(async (resolve) => {
    ...
    try {
      ...
      console.log("error to read file privateKeyDKIM", error);
    }
    ...
    var msg =
      '<!DOCTYPE html><html><body style="background-color: #fff4e5;">' + text;
    if (addFooter) {
    ...
    var mailOptions = {
      ...
      headers: {
        "List-Unsubscribe":
          "<mailto:unsubscribe@memoriatest.online?subject=Cancelar subscrição>, <https://memoriatest.online>",
      },
      //TODO DKIM
    };
